...
const AuthPage: FC = () => {
  ...
  const formContent = () => {
    switch (userType) {
      case "Agency":
        return (
          <AgencyRegister tabIndex={tabIndex} changeTabIndex={changeTabIndex} />
        );

      case "Brand":
        return (
          <BrandRegister tabIndex={tabIndex} changeTabIndex={changeTabIndex} />
        );
            ...
            <>
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    changeRegisterData("country", e.target.value)
                  }
                />
              </div>
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={(e) => changeRegisterData("city", e.target.value)}
                />
              </div>
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    changeRegisterData("website", e.target.value)
                  }
                />
              </div>
              <div className="mb-3">
                ...
                <div className="w-100 d-flex">
                  <input
                    ...
                    onChange={(e) =>
                      changeRegisterData("amazon_link", e.target.value)
                    }
                  />
          ...
          <>
            <div className="mb-3">
              ...
              <input
                ...
                onChange={(e) => changeRegisterData("name", e.target.value)}
              />
            </div>
            <div className="mb-3">
              <label htmlFor="Address" className="form-label">
              ...
              <input
                ...
                onChange={(e) => changeRegisterData("address", e.target.value)}
              />
            </div>
            <div className="mb-3">
              <label htmlFor="country" className="form-label">
              ...
              <input
                ...
                id="country"
                value={registerData.country}
                onChange={(e) => changeRegisterData("country", e.target.value)}
              />
            </div>
            <div className="mb-3">
              <label htmlFor="email" className="form-label">
